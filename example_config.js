...
// To build the extension, create a 'config.js' file in the root of this project.
...
export default {
  ...
  // The public-facing URL for your Supabase project.
  API_URI: "https://<YOUR_PROJECT_ID>.supabase.co",
